...
public class Address extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Address\",\"namespace\":\"io.zenwave360.modulith.events.scs.dtos.avro\",\"fields\":[{\"name\":\"street\",\"type\":\"string\"},{\"name\":\"city\",\"type\":\"string\"}]}");
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: street = (CharSequence)value$; break;
   ...
   * @return A new Address RecordBuilder
   */
  public static io.zenwave360.modulith.events.scs.dtos.avro.Address.Builder newBuilder(io.zenwave360.modulith.events.scs.dtos.avro.Address.Builder other) {
    if (other == null) {
      return new io.zenwave360.modulith.events.scs.dtos.avro.Address.Builder();
    } else {
   ...
   * @return A new Address RecordBuilder
   */
  public static io.zenwave360.modulith.events.scs.dtos.avro.Address.Builder newBuilder(io.zenwave360.modulith.events.scs.dtos.avro.Address other) {
    if (other == null) {
      return new io.zenwave360.modulith.events.scs.dtos.avro.Address.Builder();
    } else {
      return new io.zenwave360.modulith.events.scs.dtos.avro.Address.Builder(other);
