...
public class PaymentMethod extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PaymentMethod\",\"namespace\":\"io.zenwave360.modulith.events.scs.dtos.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"type\",\"type\":{\"type\":\"enum\",\"name\":\"PaymentMethodType\",\"symbols\":[\"VISA\",\"MASTERCARD\"]}},{\"name\":\"cardNumber\",\"type\":\"string\"}]}");
   ...
   */
  public PaymentMethod(Integer id, io.zenwave360.modulith.events.scs.dtos.avro.PaymentMethodType type, CharSequence cardNumber) {
    this.id = id;
    this.type = type;
  ...
  public void put(int field$, Object value$) {
    ...
    case 1: type = (io.zenwave360.modulith.events.scs.dtos.avro.PaymentMethodType)value$; break;
    case 2: cardNumber = (CharSequence)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   * @return A new PaymentMethod RecordBuilder
   */
  public static io.zenwave360.modulith.events.scs.dtos.avro.PaymentMethod.Builder newBuilder(io.zenwave360.modulith.events.scs.dtos.avro.PaymentMethod.Builder other) {
    if (other == null) {
      return new io.zenwave360.modulith.events.scs.dtos.avro.PaymentMethod.Builder();
    } else {
   ...
   * @return A new PaymentMethod RecordBuilder
   */
  public static io.zenwave360.modulith.events.scs.dtos.avro.PaymentMethod.Builder newBuilder(io.zenwave360.modulith.events.scs.dtos.avro.PaymentMethod other) {
    if (other == null) {
      return new io.zenwave360.modulith.events.scs.dtos.avro.PaymentMethod.Builder();
    } else {
      return new io.zenwave360.modulith.events.scs.dtos.avro.PaymentMethod.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentMethod>
    ...
    /**
      ...
      * @return This builder.
      */
    public io.zenwave360.modulith.events.scs.dtos.avro.PaymentMethod.Builder setType(io.zenwave360.modulith.events.scs.dtos.avro.PaymentMethodType value) {
    ...
    public PaymentMethod build() {
      try {
        ...
        record.type = fieldSetFlags()[1] ? this.type : (io.zenwave360.modulith.events.scs.dtos.avro.PaymentMethodType) defaultValue(fields()[1]);
