...
public class CustomerEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public CustomerEvent(CharSequence name, CharSequence email, java.util.List<io.zenwave360.modulith.events.scs.dtos.avro.Address> addresses, Long id, Integer version, java.util.List<io.zenwave360.modulith.events.scs.dtos.avro.PaymentMethod> paymentMethods) {
    this.name = name;
    this.email = email;
  ...
  public void put(int field$, Object value$) {
    ...
    case 2: addresses = (java.util.List<io.zenwave360.modulith.events.scs.dtos.avro.Address>)value$; break;
    case 3: id = (Long)value$; break;
    case 4: version = (Integer)value$; break;
    case 5: paymentMethods = (java.util.List<io.zenwave360.modulith.events.scs.dtos.avro.PaymentMethod>)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   * @return A new CustomerEvent RecordBuilder
   */
  public static io.zenwave360.modulith.events.scs.dtos.avro.CustomerEvent.Builder newBuilder(io.zenwave360.modulith.events.scs.dtos.avro.CustomerEvent.Builder other) {
    if (other == null) {
      return new io.zenwave360.modulith.events.scs.dtos.avro.CustomerEvent.Builder();
    } else {
   ...
   * @return A new CustomerEvent RecordBuilder
   */
  public static io.zenwave360.modulith.events.scs.dtos.avro.CustomerEvent.Builder newBuilder(io.zenwave360.modulith.events.scs.dtos.avro.CustomerEvent other) {
    if (other == null) {
      return new io.zenwave360.modulith.events.scs.dtos.avro.CustomerEvent.Builder();
    } else {
      return new io.zenwave360.modulith.events.scs.dtos.avro.CustomerEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CustomerEvent>
    ...
    /**
      ...
      * @return This builder.
      */
    public io.zenwave360.modulith.events.scs.dtos.avro.CustomerEvent.Builder setAddresses(java.util.List<io.zenwave360.modulith.events.scs.dtos.avro.Address> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.zenwave360.modulith.events.scs.dtos.avro.CustomerEvent.Builder setPaymentMethods(java.util.List<io.zenwave360.modulith.events.scs.dtos.avro.PaymentMethod> value) {
    ...
    public CustomerEvent build() {
      try {
        ...
        record.addresses = fieldSetFlags()[2] ? this.addresses : (java.util.List<io.zenwave360.modulith.events.scs.dtos.avro.Address>) defaultValue(fields()[2]);
        ...
        record.paymentMethods = fieldSetFlags()[5] ? this.paymentMethods : (java.util.List<io.zenwave360.modulith.events.scs.dtos.avro.PaymentMethod>) defaultValue(fields()[5]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (a0 == null) {
        a0 = new SpecificData.Array<io.zenwave360.modulith.events.scs.dtos.avro.Address>((int)size0, SCHEMA$.getField("addresses").schema());
        this.addresses = a0;
      } else a0.clear();
      SpecificData.Array<io.zenwave360.modulith.events.scs.dtos.avro.Address> ga0 = (a0 instanceof SpecificData.Array ? (SpecificData.Array<io.zenwave360.modulith.events.scs.dtos.avro.Address>)a0 : null);
      ...
      if (a1 == null) {
        a1 = new SpecificData.Array<io.zenwave360.modulith.events.scs.dtos.avro.PaymentMethod>((int)size1, SCHEMA$.getField("paymentMethods").schema());
        this.paymentMethods = a1;
      } else a1.clear();
      SpecificData.Array<io.zenwave360.modulith.events.scs.dtos.avro.PaymentMethod> ga1 = (a1 instanceof SpecificData.Array ? (SpecificData.Array<io.zenwave360.modulith.events.scs.dtos.avro.PaymentMethod>)a1 : null);
