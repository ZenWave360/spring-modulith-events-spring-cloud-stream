...
public class CustomerEvent extends org.apache.avro.specific.SpecificRecordBase
    ...
    private static final BinaryMessageEncoder<CustomerEvent> ENCODER = new BinaryMessageEncoder<>(MODEL$, SCHEMA$);

    private static final BinaryMessageDecoder<CustomerEvent> DECODER = new BinaryMessageDecoder<>(MODEL$, SCHEMA$);
    ...
    @SuppressWarnings("unchecked")
    private static final org.apache.avro.io.DatumWriter<CustomerEvent> WRITER$ = (org.apache.avro.io.DatumWriter<CustomerEvent>) MODEL$
    ...
    @SuppressWarnings("unchecked")
    private static final org.apache.avro.io.DatumReader<CustomerEvent> READER$ = (org.apache.avro.io.DatumReader<CustomerEvent>) MODEL$
